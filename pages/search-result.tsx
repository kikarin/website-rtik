...
import { FaArrowAltCircleRight, FaBuilding, FaChalkboardTeacher, FaChartBar, FaChartLine, FaCodeBranch, FaEnvelope, FaFacebook, FaFilePdf, FaInstagram, FaPhoneAlt, FaRegHandshake, FaSchool, FaTwitter, FaUserTie, FaUsers } from 'react-icons/fa';
...
<h3 className="container-custom mx-auto text-center text-xl md:text-4xl font-bold mb-5 text-white inline-flex items-center justify-center">Hasil Pencarian</h3>
</div>
    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500">
        ...
        <tbody>
            <tr className="odd:bg-white even:bg-gray-100 border-b">
                ...
                <td className="px-6 py-4">
                Evaluasi PPKM darurat dan cakupan testing, tracing dan vaksinasi
                </td>
                <td className="px-6 py-4">
                    <a href="#" className="font-medium bg-yellow-400 text-white py-1 px-2 rounded-lg shadow-lg hover:underline inline-flex items-center"><FaArrowAltCircleRight /> Selengkapnya</a>
                </td>
            </tr>
            <tr className="odd:bg-white even:bg-gray-100 border-b">
                <td className="px-3 py-4">
                ...
                <td className="px-6 py-4">
                Lokakarya VL Testing Bagi Orang dengan HIV
                </td>
                <td className="px-6 py-4">
                    <a href="#" className="font-medium bg-yellow-400 text-white py-1 px-2 rounded-lg shadow-lg hover:underline inline-flex items-center"><FaArrowAltCircleRight /> Selengkapnya</a>
                </td>
            ...
            <tr className="odd:bg-white even:bg-gray-100 border-b">
                ...
                <td className="px-6 py-4">
                Rapat Koordinasi Target testing & Tracing Covid-19
                </td>
                <td className="px-6 py-4">
                    <a href="#" className="font-medium bg-yellow-400 text-white py-1 px-2 rounded-lg shadow-lg hover:underline inline-flex items-center"><FaArrowAltCircleRight /> Selengkapnya</a>
                </td>
            ...
            <tr className="odd:bg-white even:bg-gray-100 border-b">
                ...
                <td className="px-6 py-4">
                Pelatihan pencatatan dan pelaporan hasil rapid test untuk diagnosis test antigen
                </td>
                <td className="px-6 py-4">
                    <a href="#" className="font-medium bg-yellow-400 text-white py-1 px-2 rounded-lg shadow-lg hover:underline inline-flex items-center"><FaArrowAltCircleRight /> Selengkapnya</a>
                </td>
            ...
            <tr className="odd:bg-white even:bg-gray-100 border-b">
                ...
                <td className="px-6 py-4">
                Pelatihan Peningkatan Kapasitas Test and Treat Petugas Kesehatan PDP HIV
                </td>
                <td className="px-6 py-4">
                    <a href="#" className="font-medium bg-yellow-400 text-white py-1 px-2 rounded-lg shadow-lg hover:underline inline-flex items-center"><FaArrowAltCircleRight /> Selengkapnya</a>
                </td>
