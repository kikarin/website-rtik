...
<h3 className="container-custom mx-auto text-center text-xl md:text-2xl font-bold text-white inline-flex items-center justify-center">Pelaksaan Vaksinasi Covid19 bagi Anak 6-11 Tahun</h3>
<p className="container-custom mx-auto text-center text-lg text-white text-yellow-300">Jumat, 31 Mei 2024</p>
</div>
...
<div className="container-custom mx-auto mb-14" data-aos="fade-up">
      ...
      <div className="w-full flex flex-col md:flex-row flex-wrap justify-around items-start">
        <div className="w-full md:w-[24%] h-auto bg-slate-200 rounded-xl shadow-md mx-1 my-1 mb-5">
            <div className="w-full h-[200px] rounded-xl relative">
            <Image
            src={album1} layout="fill" objectFit="cover" className="rounded-xl hover:scale-95 duration-500"
            alt=""
          />
            </div>
          ...
          <div className="w-full md:w-[24%] h-auto bg-slate-200 rounded-xl shadow-md mx-1 my-1 mb-5">
            <div className="w-full h-[200px] rounded-xl relative">
            <Image
            src={album2} layout="fill" objectFit="cover" className="rounded-xl hover:scale-95 duration-500"
            alt=""
          />
            </div>
