  ...
  const programs = [
    {
      ...
      description:
        "Ajang tahunan Relawan TIK Indonesia menjadi simpul utama pergerakan kerelawanan yang dikemas dengan Festival",
      image: "/4-2.png",
      link: "/festival-tik",
    },
    {
      ...
      description:
        "ARTIKA merupakan Komite dalam Sumber Daya Manusia Penelitian dan Pengembangan (SDM Litbang) Relawan TIK Indonesia.",
      image: "/aakdemi.png",
      link: "/akademi-rtik",
    },
    {
      ...
      description:
        "Tempat dan atau lembaga yang dapat memberikan fasilitas pelaksanaan uji kompetensi, yang telah diverifikasi oleh LSP berlisensi.",
      image: "/1-2.png",
      link: "/tuk-ertik",
    },
    {
      ...
      title: "RTIK Talent",
      description:
        "Wadah talenta terbaik Relawan TIK Indonesia yang memiliki kompetensi dan kemampuan kecakapan digital untuk SDM unggul",
    ...
    },
    {
      ...
      description:
        "Program edukasi dan sosialisasi Daring dari Relawan TIK Indonesia untuk masyarakat secara serentak diseluruh daerah",
      image: "/2-3.png",
      link: "/rtik-berkreasi",
    },
    {
      ...
      title: "eRTIK Pay",
      description:
        "Aplikasi keanggotaan sekaligus PPOB bersama yang dikembangkan oleh Relawan TIK bersama mitra sebagai platform anggota",
      image: "/RTIK-Pay.png",
      link: "/ertik-pay",
    },
  ];
        ...
        >
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 text-center mb-4">
              Program dan Kegiatan Relawan TIK Indonesia memiliki acuan utama
              dari program kerja yang lahir dari analisis serta riset atas
              kebutuhan masyarakat terhadap urgensi penerapan TIK yang telah
              disepakati melalui Rapat Kerja, program dan kegiatan lainnya
              berbasis kolaborasi dengan mitra, beberapa kegiatan rutin yang
              telah dijalankan oleh Relawan TIK Indonesia diantaranya :
            </p>
          </div>
        </div>
      </div>
