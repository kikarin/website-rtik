...
export default function ProfilRtik() {
  ...
  return (
    <>
      ...
      <div className="w-full relative">
        <div className="w-full h-auto relative z-30">
          <div className="flex flex-col h-auto items-center">
            <nav className="w-full bg-white relative shadow-lg border-b-[5px] border-b-red-600">
              <div className="w-full bg-blue-800 py-2 hidden md:block">
                <div className="container-custom mx-auto flex flex-row justify-center text-sm text-white">
                  <div className="inline-flex items-center mx-2">
                    <FaMapMarkerAlt className="mr-1" /> Plaza Indah Bogor, Blok
                    B2, Jl. Saleh Iskandar, Kedung Badak, Kota Bogor
                  </div>
                  <div className="inline-flex items-center mx-2">
                    <FaEnvelope className="mr-1" /> humas@relawantik.or.id
                  </div>
                  <div className="inline-flex items-center mx-2 border-l border-l-white px-4">
                    Media Sosial :
                  </div>
                  <Link href="">
                    <div className="inline-flex items-center mx-2 hover:text-yellow-400 hover:cursor-pointer">
                      <FaFacebook />
                    </div>
                  </Link>
                  <Link href="">
              ...
              <div className="container-custom flex flex-wrap items-center justify-between mx-auto">
                ...
                <button
                  ...
                  type="button"
                  className="inline-flex items-center p-2 w-10 h-10 bg-white justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
                >
                ...
                >
                  <ul className="flex flex-col p-6 mt-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                    <Link href="/">
                      <li>
                        <div className="uppercase cursor-pointer block px-5 py-2 text-black font-regular hover:bg-blue-800 hover:text-white rounded-3xl duration-500 hover:scale-110">
                          Beranda
                        </div>
                      </li>
                    </Link>
      ...
      {/* Hero Section */}
      <div className="w-full bg-blue-800 py-16 md:py-24">
      ...
      <div className="container-custom mx-auto py-8 md:py-16 px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              Relawan TIK Indonesia merupakan organisasi sosial kemasyarakatan
              bersifat nirlaba, independen, philantropis dan mandiri sebagai
              upaya untuk pengembangan pengetahuan dan keterampilan bagi
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Dirintis sejak tahun 2008 sebagai bentuk sinergi dan
                    kolaborasi berbagai unsur pemangku kepentingan
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Fokus pada pengembangan dan pemberdayaan masyarakat melalui
                    teknologi informasi
                  </p>
                </div>
              </div>
        ...
        <div className="bg-sky-50 p-4 md:p-8 rounded-3xl w-full mt-10">
          <h1 className="text-3xl md:text-4xl mb-6 text-blue-800 text-center">
            Kepengurusan Pusat
          </h1>
          <div className="w-full flex flex-row flex-wrap justify-around">
            ...
            <div className="w-full md:w-[19%] py-7 border-b-4 mb-5 bg-white odd:border-red-600 even:border-blue-800 rounded-3xl">
              ...
              <div className="p-2 text-center">
                ...
                <h1 className="text-sm text-slate-500">
                  Bidang Pembinaan Organisasi dan Kaderisasi
                </h1>
              </div>
            </div>
        ...
        {/* Tujuan Section */}
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-10 md:mb-20">
  ...
  <div className="p-6 md:p-8">
            <div
              className="prose max-w-none text-gray-600 space-y-6"
              data-aos="fade-up"
            >
              <p className="leading-relaxed">
                Pengorganisasian Relawan TIK dimaksudkan sebagai upaya terpadu
                dan lintas sektoral untuk mengoptimalkan peran serta, kontribusi
                dan pemahaman para pakar, praktisi dan akademisi yang menguasai
                pemanfaatan TIK bagi kemajuan bangsa dan kemaslahatan
                masyarakat, serta memiliki komitmen dan perhatian yang tinggi
                bagi peningkatan kualitas kehidupan masyarakat dan bangsa
                Indonesia.
              </p>

              <p className="leading-relaxed">
                Organisasi Relawan TIK (baik secara nasional saat ini dan kelak
                berkepanjangan di harapkan hadir di daerah, perdesaan perkotaan
                dan Kawasan perbatasan) salah satu upayanya adalah
                memobilisasikan potensi masyarakat yang memiliki kesempatan,
                kemauan dan kemampuan pengelolaan manfaat TIK dari berbagai
                lapisan dan golongan untuk menaruh kepedulian atas keperluan
                bangsa Indonesia dalam mengatasi kesenjangan digital.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Menyiapkan anggota dalam penguasaan pengetahuan, sikap dan
                    keterampilan individual maupun kerja kelompok guna
                    menyelenggarakan tugas-tugas edukasi sosial, pemberdayaan
                    maupun kegiatan incidental.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Menjadikan Relawan TIK sebagai satuan yang mampu bereaksi
                    cerdas, tanggap, bergerak cepat serta bertindak cermat dalam
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Berkontribusi dan partisipasi dalam berbagai kegiatan
                    pembangunan, kemasyarakatan serta berperan dalam tugas
                    kemanusiaan, dengan cara mengoptimalkan pemanfaatan TIK bagi
                    kemaslahatan masyarakat dan kemajuan bangsa Indonesia.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Menjadikan Relawan TIK sebagai pribadi, sekaligus warga masyarakat
              unggulan, yang siap siaga mengemban misi sosial, kemasyarakatan
              dan kemanusiaan bagi pemberdayaan masyarakat melalui
              pemanfaatan/penguasaan keterampilan teknologi informasi dan
              komunikasi untuk kemaslahatan masyarakat dan kemajuan bangsa.
            </p>
          </div>
          ...
          >
            ...
            <div className="p-6">
              <div className="prose prose-sm max-w-none text-gray-600">
                ...
                <div className="mb-6">
                  <p className="leading-relaxed">
                    Kami Datang dengan Genderang Perang
                    <br />
                    Melawan Keterbelakangan…
                    <br />
                    Membawa Panji Panji Kemajuan
                    <br />
                ...
                <div className="pl-4 border-l-4 border-blue-600 mb-6">
                  ...
                  <p className="leading-relaxed">
                    Inilah Kami Derap Relawan
                    <br />
                    Teknologi Informasi dan Komunikasi
                    <br />
                    Inilah Kami sang Pembaharu…
                    <br />
                ...
                <div className="mb-6">
                  <p className="leading-relaxed">
                    Dengan Jiwa Pancasila Kita Tebarkan Ilmu
                    <br />
                    Mencerdaskan Kehidupan Bangsa
                    <br />
                    Dengan Berkah Ilahi Ayo Membangun Negeri
                    <br />
                ...
                <div className="mb-6">
                  <p className="leading-relaxed">
                    Kami Ikhlas Untuk Membangun Bangsa,
                    <br />
                    Mengabdi Untuk Ilmu Pertiwi
                    <br />
                    Nurani menjadi Pegangan Kami
                    <br />
            ...
            <div className="p-6">
              <ol className="list-decimal list-inside space-y-4 text-gray-600">
                <li className="leading-relaxed">
                  Kami Relawan TIK bertekad membantu masyarakat dalam
                  pemanfaatan Teknologi Informasi dan Komunikasi untuk kemajuan
                  bangsa
                </li>
                <li className="leading-relaxed">
                  Kami relawan TIK bertekad mengembangkan program informasi,
                  advokasi, edukasi dan komunikasi untuk meningkatkan e‐literasi
                </li>
                <li className="leading-relaxed">
                  Kami relawan TIK bertekad bersama pemerintah mewujudkan
                  masyarakat Indonesia Informatif
                </li>
                <li className="leading-relaxed">
                  Kami relawan TIK siap membantu optimalisasi pemanfaatan
                  Teknologi Informasi dan Komunikasi di daerah bencana
                </li>
                <li className="leading-relaxed">
                  Kami relawan TIK siap berkorban tanpa pamrih memberdayakan
                  masyarakat melalui pemanfaatan TIK
                </li>
              </ol>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6">
              <div className="prose prose-sm max-w-none text-gray-600 space-y-4">
                <p>
                  Padamu Negeriku Ku Tetap Berdiri Tegak
                  <br />
                  Untukmu Bangsaku Ku Mengabdi Tanpa Pamrih
                  <br />
                  Dengan Relawan Teknologi Informasi dan Komunikasi
                  <br />
                  Wadah Mandiri… Berkipirah Untuk Negri…
                </p>

                <p>
                  Sembah Sujudku… Duhai Tuhanku yang Agung…
                  <br />
                  Hormatku… Banggaku… Ibu Pertiwi Tercinta…
                </p>

                <p className="font-semibold">
                  Dengan Relawan Teknologi Informasi dan Komunikasi
                  <br />
                  Wadah Mandiri… Berbakti Untuk Negri…
                </p>
